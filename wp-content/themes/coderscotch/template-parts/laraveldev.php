<?php /* Template Name: Laraveldev Page Template */
get_header();
?>
<section class="hero hero--inner cslaravel_bg ">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-5">
                <div class="about-picture">
                    <img src="<?= get_field('lareveldev_image'); ?>" alt="Hire Laravel Developer" title="Hire Laravel Developer" width="510" />
                </div>
            </div>
        </div>
    </div>
                ...
                while (have_rows('work_list')) : the_row(); ?>
                    <div class="serviceboxcol">
                        <div class="serviceboxitem">
                            <img src="<?= get_sub_field('list_image'); ?>" width="50" height="50" alt="<?= get_sub_field('list_title'); ?>" />
