<?php /* Template Name: React Native Page Template */
 get_header();?>
<section class="hero hero--inner reactnative_bg ">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-5 mt-0">
                <div class="about-picture">
                    <img src="<?= get_field('lareveldev_image'); ?>" title="Hire React Native App Developer" alt="Hire React Native App Developer" width="510" />
                </div>
            </div>
        </div>
    </div>
